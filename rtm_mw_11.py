...
if __name__ == '__main__':
  print('helo')
  TCP_IP = '192.168.2.182'
  TCP_PORT = 502
  data = [2,0,0,26,0]#141,0,142,0,143,0,140,0,139,0,138,0,137,0,136,0]#,152,0,150,0]#103,0,104,105,0,106,0,107,0,108,0,109,0,110,0,111,0,112,0,113,0,114,0,115,0,116,0,117,0]#,116,0,117,0]
