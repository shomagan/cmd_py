...
if __name__ == '__main__':
  ...
  TCP_PORT = 502
  data = [2,136,0,137,0,138,0,139,0,140,0,141,0,142,0,143,0]#,145,0,146,0]#141,0,142,0,143,0,140,0,139,0,138,0,137,0,136,0]#,152,0,150,0]#103,0,104,105,0,106,0,107,0,108,0,109,0,110,0,111,0,112,0,113,0,114,0,115,0,116,0,117,0]#,116,0,117,0]
  Packet = rtm_mw.RTM_MW(data)
  Packet.RetranNum = 0
  Packet.DestOne = [8,0,7]
  Packet.DestTwo =  [9,0,7]
