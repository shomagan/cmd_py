...
#  print (0x02f6)
  ...
  data = [2,11,0]#,81,,82,0,100,0]#,0x0b,0x00,0x0b,0x00,0x0b,0x00,0x0b,0x00,0x0b,0x00,0x0b]#,0x00,0x0b,0x00,0x0b,0x00,0x0b,0x00,0x0b,0x00,0x0b,0x00,0x0b,0x00,0x0b,0x00]
...
#    if msvcrt.kbhit():
    ...
    if ord(q) == 113:#q
      ...
      try:
        ...
        error_log = open('error_log_TCP_3.txt','a')
      ...
      if data_buf:
        ...
        mac = [2,32,0,59,0,25,71]
        if (Packet.DataInPacket!= mac):
