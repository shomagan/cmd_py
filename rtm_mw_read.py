...
#  TCP_IP_1 = '172.16.1.3'
  ...
  data = [1,0,0,1,0]#,156,0,157,0,158,0,159,0,160,0,161,0,162,0,163,0]#,145,0,146,0]#141,0,142,0,143,0,140,0,139,0,138,0,137,0,136,0]#,152,0,150,0]#103,0,104,105,0,106,0,107,0,108,0,109,0,110,0,111,0,112,0,113,0,114,0,115,0,116,0,117,0]#,116,0,117,0]

  Packet_1 = rtm_mw.RTM_MW(data)
  Packet_1.RetranNum = 0
  Packet_1.DestOne = [8,1,4]
