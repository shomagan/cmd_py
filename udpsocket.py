...
#  rtm_mw_packet= [0xfa,0x13,0x00,0x00,0x00,0x07,0x00,0x02,0x04,0x01,0x05,0x01,0x01,0x01,0x01,0x12,0x00,0xa2,0x78]
  rtm_mw_packet = [0xfa,0x1b,0x00,0x00,0x00,0x07,0x00,0x02,0x03,0x00,0x08,0x03,0x01,0x01,3,6,0,2,230,45,0,17,0,26,0]
  CRC = RTM64CRC16(rtm_mw_packet, len(rtm_mw_packet))
  rtm_mw_packet.append(CRC&0xFF)
  rtm_mw_packet.append((CRC>>8)&0xFF)
  rtm_mw_packet_1 = [0xfa,0x13,0x00,0x00,0x00,0x07,0x00,0x02,0x03,0x00,0x08,0x03,0x01,0x01,2,7,0]
  CRC = RTM64CRC16(rtm_mw_packet_1, len(rtm_mw_packet_1))
  rtm_mw_packet_1.append(CRC&0xFF)
  rtm_mw_packet_1.append((CRC>>8)&0xFF)
...
#  rtm_mw_packet= [0xfa,0x13,0x00,0x00,0x00,0x07,0x00,0x02,0x04,0x01,0x05,0x01,0x01,0x01,0x02,0x12,0x00,0xf2,0x21]
  ...
  while 1:
    ...
    if ord(q) == 113:#q
      ...
      Packet_str = bytearray(rtm_mw_packet_1[0:])
      sock.sendto(Packet_str,(UDP_IP, UDP_PORT_SERVER))
